...
After an [[Office hours with Pedro]] I understand that building a platform from scratch is too big of an ask and might leave me with no time to explore the interaction aspects of TTS and with no time to develop the character behind the robot. I starting a journal about [[What is character in a robot?]].
...
I've expanded it to a virtual map based in obsidian as can be viewed here:
![[Mind Map 1.canvas]]
...
Option 1:
1. Topic - AI Companionship
2. Attribute - Interactive / Proactive

Option 2:
1. Topic - Automation of Care between 2 people: connected devices living between partners to send embodied messages from one to the other
2. Attribute - Still thinking