...
How its done:
Mainly - its all local to a netwrok they know and control. Not something encrypted like NYU's... They used a Node.js library called **`local-devices`**(https://github.com/DylanPiercey/local-devices) to find devices that are _connected to the same Wi-Fi network_ as the computer running the server. It works by:
